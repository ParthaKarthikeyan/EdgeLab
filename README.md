...
| Venues | premarket low-floats, futures, crypto | crypto (and later micro futures) only — chosen by cost structure |
| Admission | strategies deployed, then measured | Gate A (2x-cost walk-forward) **before** any bot exists |
| Books | as many as we built | max two concurrent paper books |
